...
public class Cart_page {
	...
	//FUNCTION BUTTON IN CART SECTION 
	public final String proceed_to_checkout_button_xpath = "//button[text()='Proceed to Checkout']";
	public final String remove_button_xpath = "//button[text()='Remove']";
